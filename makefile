...
MOUNTFLAGS := -v /mnt/nfs/Download/incomplete:/incomplete -v /mnt/nfs/Download/complete:/download -v /mnt/nfs/Download/watch:/watch
OTHERFLAGS := --cap-add NET_ADMIN -e VPN_GW=172.17.0.2 -e WORKER_LAN=192.168.2.0\/24
PORTFLAGS  := -p 9091:9091
